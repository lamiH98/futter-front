                ...
                children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(top: 28.h, left: 16.w ,bottom: 22.h),
                            child: CustomText(text: '10%', fontSize: 56.sp, fontWeight: FontWeight.bold, color: Colors.white),
                          ),
                          Padding(
                            padding: EdgeInsets.only(left: 8.h),
                            child: CustomText(text: 'Cashback', fontSize: 26.sp, fontWeight: FontWeight.bold, color: Colors.white),
                          ),
                          Padding(
                            padding: EdgeInsets.only(left: 8.h, top: 19.h),
                            child: CustomText(text: 'Aug 17-23', fontSize: 18.sp, color: Colors.white),
                          ),
                        ]
                      ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomText(text: 'Terms & conditions applied', color: Colors.white, fontSize: 16.sp)
                      ]
                    ),
                  ),
                ]
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomText(text: 'What\'s inside', fontWeight: FontWeight.bold, fontSize: 18.sp),
                  Padding(
                    padding: EdgeInsets.only(top: 12.h, bottom: 28.h),
                    child: CustomText(text: 'A limited time 10% cashback on every product you buy on website', color: textColor, height: 1.3),
                  ),
                  CustomText(text: 'What\'s inside', fontWeight: FontWeight.bold, fontSize: 18.sp),
                  Padding(
                    padding: EdgeInsets.only(top: 12.h, bottom: 12.h),
                    child: CustomText(text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit ', color: textColor, height: 1.4,),
                  ),
                  Padding(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10.w),
                              CustomText(text: 'Voucher Name', color: mainColor, fontSize: 18)
                            ]
                          ),
                        ),
                        Flexible(
