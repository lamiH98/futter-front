          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Center(child: CustomText(text: 'Forgot Password', color: mainColor, fontSize: 32.sp, fontWeight: FontWeight.bold,)),
              ),
              ...
              CustomText(text: 'WE WILL SEND A LINK TO YOUR MAIL TO RESET YOUR PASSWORD', color: textColor, height: 1.8, fontSize: 17.0),
              Padding(
                padding: EdgeInsets.only(top: ScreenUtil().setHeight(14), bottom: ScreenUtil().setHeight(14)),
                child: ElevatedButton(
                  child: CustomText(text: 'SEND LINK', color: Color(0xFFAFAFAF),),
                  onPressed: sendLink,
